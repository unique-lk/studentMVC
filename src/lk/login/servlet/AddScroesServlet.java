...
public class AddScroesServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          ScoresDAO sdo=new ScoresDAO();
			...
			if(sdo.doInsert(sb)){
				 ...
				 request.getRequestDispatcher("addscores.jsp").forward(request, response); 
			}
		} catch (Exception e) {
			 e.printStackTrace();
			 request.setAttribute("error","您的信息填写错误，请重新输入信息！");
			 request.getRequestDispatcher("addscores.jsp").forward(request, response); 
		}
