...
<html>
  ...
  <body>
    <form id="form1" name="form1" method="post" action="SelectScoresByNameServlet">
  <table width="389" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center"><span class="STYLE1">根据学生姓名查询学生信息</span></div></td>
    </tr>
      <p><a class="btn" href="welcome.jsp">返回菜单页</a></p>
    <tr>
      <td width="162" height="31">学生姓名</td>
      <td width="217"><label>
        <input name="stud_name" type="text" value="" />
      </label></td>
    </tr>
       <tr>
      <td width="217"><label>
